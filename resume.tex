...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelors of Science in Computer Science and Engineering; GPA: 3.92}{Aug. 2020 -- Expected December 2023}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Collaborated with the Air Force Research Labs to create a pipeline to upload images and metadata onto the HyperThought system for further analysis and identification}
      ...
      \resumeItemListStart
        \resumeItem{Learned about zkSNARKs, proof systems, and other cryptographic primitives while being mentored by Srinath Setty}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Go, Rust, C/C++, Java, \LaTeX, JavaScript, SQL, Python} \\
     \textbf{Tools \& Systems}{: Git, Docker, eBPF, Linux, Prometheus, Kubernetes} \\
    }}
 \end{itemize}

%-----------OTHER-----------
\section{Citizenship and Work Authorization}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
        U.S. Citizen
    }}
